	...
	for _, message := range messages {
		for callIndex, call := range message.ToolCalls {
			callRows = append(callRows, bunmodel.ToolCall{
				...
				ResultContentLength: optionalCanonicalInt(ResolveResultContentLength(call.ResultContent, call.ResultContentLength)),
				ResultContent:       optionalCanonicalString(DedupToolCallResultSummary(call.ResultContent, call.ResultEvents)),
